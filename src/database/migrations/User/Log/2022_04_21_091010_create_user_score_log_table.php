 ...
 * @LastEditTime: 2024-02-25 22:54:29
 */
...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_score_log', function (Blueprint $table) {
            ...
            $table->id()->comment('主键--用户积分日志表');
			$table->unsignedBigInteger('user_id')->default(0)->comment('用户id');
            $table->unsignedBigInteger('revision')->default(0)->comment('乐观锁');
            $table->unsignedTinyInteger('type')->default(0)->comment('0未知 10增加 20 减少');
        ...
        DB::statement("ALTER TABLE `{$prefix}user_score_log` comment '用户积分日志表'");
