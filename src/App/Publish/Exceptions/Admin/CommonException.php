 ...
 * @LastEditTime: 2024-06-02 01:11:06
 */
...
class CommonException extends Exception
{
    ...
    function __construct($errorKey = null)
    {
        if($errorKey)
        {
            ...
            $message = config("admin_code.{$this->errorKey}.msg");
        ...
        $this->emailArray = config('admin_code.EmailArray');
    }
	...
	{
		return code(config("admin_code.{$this->errorKey}"));
	}
}
