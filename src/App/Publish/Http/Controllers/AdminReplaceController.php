...
class AdminReplaceController extends Controller
{
    /**
     * 获取默认选项
     */
    ...
    public function findReplace(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            $result = ReplaceFacade::findReplace(f($validated),$admin);
        }
    ...
    public function addReplace(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            $result = ReplaceFacade::addReplace(f($validated),$admin);
        }
    ...
    public function updateReplace(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
          ...
          $validator = Validator::make(
           ...
           $result = ReplaceFacade::updateReplace(f($validated),$admin);
        }
    ...
    public function moveReplace(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('super-role'))
        {
            ...
            $result = ReplaceFacade::moveReplace(f($validated),$admin);
        }
    ...
    public function deleteReplace(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            $result = ReplaceFacade::deleteReplace(f($validated),$admin);
        }
    ...
    public function multipleDeleteReplace(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            $result = ReplaceFacade::multipleDeleteReplace(f($validated),$admin);
        }
    ...
    public function disableReplace(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            $result = ReplaceFacade::disableReplace(f($validated),$admin);
        }
    ...
    public function multipleDisableReplace(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            $result = ReplaceFacade::multipleDisableReplace(f($validated),$admin);
        }
    ...
    public function getReplaceUnionRegion(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            $result = ReplaceFacade::getReplaceUnionRegion(f($validated),$admin);
        }
    ...
    public function updateReplaceUnionRegion(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            $result = ReplaceFacade::updateReplaceConfigUnionRegion(f($validated),$admin);
        }
